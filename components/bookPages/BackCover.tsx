		...
		<ClientOnlyPortal selector="#backCover">
			<div>
				...
				<div className={styles.text}>
					<p>Want to catch up with newly released movies? Search for old favorites and find out where to stream? Checkout my new <a href="https://movie-graphql.vercel.app/" target="_blank" rel="noopener noreferrer">website</a>!</p>
					<hr/>
